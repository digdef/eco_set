                                        ...
                                        <p>
                                            ...
                                            <a href="#" class="filter-item-info">
                                                ...
                                                <span class="filter-item-info-hidden">
                                                    ...
                                                    {!! str_replace(array('<p>', '</p>'), array('', '<br>'), $hint->septic_type) !!}
                                                </span>
                                            </a>
                                        </p>
                                    ...
                                    <div class="filter-item-cnt">
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="type_septic[]"
                                                   value="Станции биологической очистки" {{ $prod->contains('type_septic: Станции биологической очистки') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                            <span class="checker-name">Станции биологической очистки</span>
                                        </label>
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="type_septic[]"
                                                   value="Био - септики" {{ $prod->contains('type_septic: Био - септики') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                    ...
                                    <div class="filter-item-title">
                                        <p>
                                            ...
                                            <a href="#" class="filter-item-info">
                                                ...
                                                <span class="filter-item-info-hidden">
                                                    <img src="/images/popup-close.svg" alt="icon-close">
                                                    {!! str_replace(array('<p>', '</p>'), array('', '<br>'), $hint->persons) !!}
                                                </span>
                                            </a>
                                        </p>
                                        <img src="/images/arrow-btm2.svg" alt="arrow">
                                    ...
                                    <div class="filter-item-cnt">
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="2" {{ $prod->contains('persons: 2') ? 'checked' : '' }}>
                                            <span class="checker">2</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="3" {{ $prod->contains('persons: 3') ? 'checked' : '' }}>
                                            <span class="checker">3</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="4" {{ $prod->contains('persons: 4') ? 'checked' : '' }}>
                                            <span class="checker">4</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="5" {{ $prod->contains('persons: 5') ? 'checked' : '' }}>
                                            <span class="checker">5</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="6" {{ $prod->contains('persons: 6') ? 'checked' : '' }}>
                                            <span class="checker">6</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="7" {{ $prod->contains('persons: 7') ? 'checked' : '' }}>
                                            <span class="checker">7</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="8" {{ $prod->contains('persons: 8') ? 'checked' : '' }}>
                                            <span class="checker">8</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="9" {{ $prod->contains('persons: 9') ? 'checked' : '' }}>
                                            <span class="checker">9</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="10" {{ $prod->contains('persons: 10') ? 'checked' : '' }}>
                                            <span class="checker">10</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="12" {{ $prod->contains('persons: 12') ? 'checked' : '' }}>
                                            <span class="checker">12</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="13" {{ $prod->contains('persons: 13') ? 'checked' : '' }}>
                                            <span class="checker">13</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="15" {{ $prod->contains('persons: 15') ? 'checked' : '' }}>
                                            <span class="checker">15</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="18" {{ $prod->contains('persons: 18') ? 'checked' : '' }}>
                                            <span class="checker">18</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="20" {{ $prod->contains('persons: 20') ? 'checked' : '' }}>
                                            <span class="checker">20</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="25" {{ $prod->contains('persons: 25') ? 'checked' : '' }}>
                                            <span class="checker">25</span>
                                        </label>
                                        <label class="checkbox-item checkbox-item-text">
                                            <input type="checkbox" name="persons[]"
                                                   value="30" {{ $prod->contains('persons: 30') ? 'checked' : '' }}>
                                    ...
                                    <div class="filter-item-title">
                                        <p>
                                            ...
                                            <a href="#" class="filter-item-info">
                                                ...
                                                <span class="filter-item-info-hidden">
                                                    <img src="/images/popup-close.svg" alt="icon-close">
                                                    {!! str_replace(array('<p>', '</p>'), array('', '<br>'), $hint->reset_type) !!}
                                                </span>
                                            </a>
                                        </p>
                                        <img src="/images/arrow-btm2.svg" alt="arrow">
                                    ...
                                    <div class="filter-item-cnt">
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="reset_type[]"
                                                   value="Самотечный" {{ $prod->contains('reset_type: Самотечный') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                            <span class="checker-name">Самотечный</span>
                                        </label>
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="reset_type[]"
                                                   value="Принудительный" {{ $prod->contains('reset_type: Принудительный') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                    ...
                                    <div class="filter-item-cnt">
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="type_of_shell[]"
                                                   value="Цилиндрический" {{ $prod->contains('type_of_shell: Цилиндрический') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                            <span class="checker-name">Цилиндрический</span>
                                        </label>
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="type_of_shell[]"
                                                   value="Прямоугольный" {{ $prod->contains('type_of_shell: Прямоугольный') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                    ...
                                    <div class="filter-item-title">
                                        <p>
                                            ...
                                            <a href="#" class="filter-item-info">
                                                ...
                                                <span class="filter-item-info-hidden">
                                                    <img src="/images/popup-close.svg" alt="icon-close">
                                                    {!! str_replace(array('<p>', '</p>'), array('', '<br>'), $hint->inset_depth) !!}
                                                </span>
                                            </a>
                                        </p>
                                        <img src="/images/arrow-btm2.svg" alt="arrow">
                                    ...
                                    <div class="filter-item-cnt">
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="insert_depth[]"
                                                   value="600" {{ $prod->contains('insert_depth: 600') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                            <span class="checker-name">600мм</span>
                                        </label>
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="insert_depth[]"
                                                   value="800" {{ $prod->contains('insert_depth: 800') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                            <span class="checker-name">800мм</span>
                                        </label>
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="insert_depth[]"
                                                   value="1200" {{ $prod->contains('insert_depth: 1200') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                            <span class="checker-name">1200мм</span>
                                        </label>
                                        <label class="checkbox-item">
                                            <input type="checkbox" name="insert_depth[]"
                                                   value="1500" {{ $prod->contains('insert_depth: 1500') ? 'checked' : '' }}>
                                            <span class="checker"><img src="/images/checker.svg" alt="checker"></span>
                                            <span class="checker-name">1500мм</span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="catalog-list">
                            @foreach($products as $product)
                                <div class="catalog-item">
                                    ...
                                    <a href="{!! route('product', [$product->url ?? $product->id]) !!}" class="catalog-item-img" >
                                        <img src="/images/{{ $product->img }}" alt="catalog">
                                    </a>
                                    <a href="{!! route('product', [$product->url ?? $product->id]) !!}"
                                       class="catalog-item-title">{{ $product->title }}</a>
                                    <p>{{ $product->header_note }}</p>
                                    <ul class="circle-list">
                                        <li>Для {{ $product->persons }} человек</li>
                                        <li>Производительность {{ $product->performance }} м3/сутки</li>
                                    ...
                                    <div class="catalog-item-links">
                                        <a href="{!! route('product', [$product->url ?? $product->id]) !!}" class="btn">подробнее</a>
