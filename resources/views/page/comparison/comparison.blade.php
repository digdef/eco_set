    ...
    <div class="main">
        ...
        <div class="comparison">
            <div class="wrapper wrapper-m">
                ...
                <div class="comparison-list {{ count($comparisons) > 0 ? '' : 'no-cnt' }}">
                                    ...
                                    <div class="comparison-top comparison-top-item">
                                            <form class="comparison-form">
                                                ...
                                                @csrf
                                                    ...
                                                    <svg class="item-trigger btn_favorites {{ $favorites_user->contains($product->id) ? 'active' : '' }}" width="25" height="24" version="1.1"
                                                    ...
                                                    <svg class="item-trigger delete-comparison" width="16" height="16"
