...
@section('content')
    <div class="main">
        ...
        <form method="post" action="/admin/product_water">
            @csrf

            <div class="form-row">
                <div class="form-group col-12">
                    <label for="text">Текст</label>
                    <textarea name="text_water" id="text" class="form-control">{!! $ceo_text->text_water !!}</textarea>
                </div>
            </div>
    ...
    <script>
        CKEDITOR.replace(document.getElementById('text'));
